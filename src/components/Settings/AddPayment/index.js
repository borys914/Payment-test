  ...
  return (
    <Typography component='div' className='add-payment'>
      <Grid container spacing={2}>
        ...
        >
          <Typography component='h2' className='title'>Pay with card</Typography>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Typography component='div' className='form-control'>
              ...
              <input
                ...
                autoComplete='off'
              />
              {errors?.card?.type === "required" && <p>This field is required</p>}
            </Typography>
            <Typography component='div' className='form-control'>
              <label>CVV</label>
              <input
            ...
            <Typography component='div' className='make-payment-btn'>
              <Button type='submit' className='fill-btn'>Make Payment</Button>
            </Typography>
          </form>
        ...
        >
          <Typography component='div' className='add-card-btn'>
            <Button variant='contained' className='fill-btn'><img src={plusImage} alt='plus icon' />Add Card</Button>
          </Typography>
        </Grid>
      </Grid>
    </Typography>
